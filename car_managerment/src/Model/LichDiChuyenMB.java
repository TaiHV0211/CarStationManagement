 ...
 * @author Hvt02
 */
public class LichDiChuyenMB {
    private int iddc;
    private String TenHangdc, BienSodc,TrangThai,DiTudc,DenBendc,NgayVaodc;

    public LichDiChuyenMB() {
    }

    public LichDiChuyenMB(String TenHangdc, String BienSodc, String TrangThai, String DiTudc, String DenBendc, String NgayVaodc) {
