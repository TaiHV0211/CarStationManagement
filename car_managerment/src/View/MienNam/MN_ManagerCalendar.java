...
import View.MienNam.*;
import Controller.DAOLichDiChuyenMN;
 ...
 * @author Hvt02
 */
public class MN_ManagerCalendar extends javax.swing.JFrame {

    /**
     * Creates new form MN_ManagerCalendar
     */
   private List<LichDiChuyenMN> calendarmt;
    private DefaultTableModel Model;
    int SelecteđIndex;
    public MN_ManagerCalendar() {
        initComponents();
        this.setLocationRelativeTo(null);
        Model = (DefaultTableModel)tbCalendarMN.getModel();
        showTable();
    }
    ...
    private void initComponents() {
        ...
        tbCalendarMN = new javax.swing.JTable();
        ...
        tbCalendarMN.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbCalendarMN.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbCalendarMNMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbCalendarMN);
    ...
    private void btnThemDCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemDCActionPerformed
        LichDiChuyenMN mt =new LichDiChuyenMN();
        ...
        JOptionPane.showMessageDialog(this, "Thông tin không được để trống");
            ...
            new DAOLichDiChuyenMN().AddCarCalendar(mt);
            showTable();
    ...
    private void btnDeleteDCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteDCActionPerformed
       SelecteđIndex = tbCalendarMN.getSelectedRow();
        LichDiChuyenMN mt = calendarmt.get(SelecteđIndex);
        JOptionPane.showConfirmDialog(this,"Bạn có chắc muốn xóa" +mt.getTenHangdc()+ "ra khỏi danh sách?");
        new DAOLichDiChuyenMN().DeleteCarCalender(mt.getIddc());
        showTable();
    ...
    private void btnUpdateDCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateDCActionPerformed
         SelecteđIndex = tbCalendarMN.getSelectedRow();
        LichDiChuyenMN m = calendarmt.get(SelecteđIndex);
        new DAOLichDiChuyenMN().DeleteCarCalender(m.getIddc());
    ...
    private void tbCalendarMNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCalendarMNMouseClicked
        SelecteđIndex = tbCalendarMN.getSelectedRow();
        LichDiChuyenMN mt = calendarmt.get(SelecteđIndex);
    ...
    }//GEN-LAST:event_tbCalendarMNMouseClicked
    ...
    private void btnFindDcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindDcActionPerformed
       String Name = txtTenHangDC.getText();        
            if(Name.length() > 0){
                calendarmt = new DAOLichDiChuyenMN().findbyName(Name);
                 Model.setRowCount(0);
                for(LichDiChuyenMN mt:calendarmt){
                    Model.addRow(new Object[]{
                    tbCalendarMN.getRowCount()+1,mt.getTenHangdc(),mt.getBienSodc(),mt.getTrangThai(),mt.getDiTudc(),mt.getDenBendc(),mt.getNgayVaodc()
                });
            }
        }
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
         try{
           ...
           if(saveFile != null){
               ...
               for(int i=0;i<tbCalendarMN.getColumnCount();i++){
                   Cell cell = rowCol.createCell(i);
                   cell.setCellValue(tbCalendarMN.getColumnName(i));
               }
               
               for(int j=0;j<tbCalendarMN.getRowCount();j++){
                   Row row = sheet.createRow(j+1);
                   for(int k=0;k<tbCalendarMN.getColumnCount();k++){
                       Cell cell = row.createCell(k);
                       if(tbCalendarMN.getValueAt(j, k)!=null){
                           cell.setCellValue(tbCalendarMN.getValueAt(j, k).toString());
                       }
                   }
               }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MN_ManagerCalendar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MN_ManagerCalendar().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbCalendarMN;
    ...
    private void showTable() {
         calendarmt = (List<LichDiChuyenMN>) new DAOLichDiChuyenMN().getListMT();
        Model.setRowCount(0);
        for(LichDiChuyenMN mt:calendarmt){
            Model.addRow(new Object[]{
            tbCalendarMN.getRowCount()+1,mt.getTenHangdc(),mt.getBienSodc(),mt.getTrangThai(),mt.getDiTudc(),mt.getDenBendc(),mt.getNgayVaodc()
