 ...
 * @author Hvt02
 */
public class MN_ManagerCar extends javax.swing.JFrame {
    ...
    int SelecteđIndex;
    public MN_ManagerCar() {
        initComponents();
        this.setLocationRelativeTo(null);
        Model = (DefaultTableModel)tbMienNam.getModel();
        showTable();
    }
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(txtBienSo, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
                                .addGap(26, 26, 26)
        ...
        tbMienNam.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbMienNam.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbMienNamMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbMienNam);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MN_ManagerCar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MN_ManagerCar().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbMienNam;
